...
class App(object):
    ...
    def install_dependency(app_name, dependency, version='latest'):
        ...
        Npm.install(
            package='{0}@{1}'.format(dependency, version),
    ...
    def update(app_name,
        ...
        if modules and App.is_dependency(
                app_name=app_name, dependency='tns-core-modules'):
            Npm.uninstall(
                package='tns-core-modules', option='--save', folder=app_path)
            Npm.install(
                package=Settings.Packages.MODULES,
                option='--save --save-exact',
                folder=app_path)
        if angular and App.is_dependency(
                app_name=app_name, dependency='nativescript-angular'):
            Npm.uninstall(
                package='nativescript-angular',
                option='--save',
                folder=app_path)
            Npm.install(
                package=Settings.Packages.ANGULAR,
                option='--save --save-exact',
                folder=app_path)
        ...
        if typescript and App.is_dev_dependency(
            ...
            Npm.uninstall(
                package='nativescript-dev-typescript',
                option='--save-dev',
                folder=app_path)
            Npm.install(
                package=Settings.Packages.TYPESCRIPT,
                option='--save-dev --save-exact',
                folder=app_path)
        ...
        if web_pack and App.is_dev_dependency(
            ...
            Npm.uninstall(
                package='nativescript-dev-webpack',
                option='--save-dev',
                folder=app_path)
            Npm.install(
                package=Settings.Packages.WEBPACK,
                option='--save-dev --save-exact',
                folder=app_path)
        ...
        if vue and App.is_dependency(
                app_name=app_name, dependency='nativescript-vue'):
            Npm.uninstall(
                package='nativescript-vue', option='--save', folder=app_path)
            Npm.install(
                package='nativescript-vue@next',
                option='--save --save-exact',
                folder=app_path)
